...
After cloning this repository to your local machine, go to the root of this repo and use the following commands to
...
Simply type `mcp_detector_correction.py`, you should see the following
