...
def test_calc_pixel_occupancy_probability(data_dir):
    ...
    with np.load(os.path.join(data_dir, "ref_pop_prof.npz")) as data:
...
def test_correct_images(data_dir):
    ...
    with np.load(os.path.join(data_dir, "ref_img_mean_prof.npz")) as data:
